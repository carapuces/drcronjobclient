...
import (
	...
	"github.com/carapuces/drcronjobclient/pkg/generated/clientset/versioned/scheme"
...
// BatchV1Client is used to interact with features provided by the batch.drp group.
type BatchV1Client struct {
	restClient rest.Interface
}

func (c *BatchV1Client) DRCronJobs(namespace string) DRCronJobInterface {
	return newDRCronJobs(c, namespace)
}
